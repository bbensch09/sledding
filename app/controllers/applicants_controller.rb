  ...
  def create
    ...
    respond_to do |format|
      if @applicant.save
        ...
        format.html { redirect_to root_path, notice: 'Your application was successfully submitted, you will be contacted shortly. You may also reach out with questions to frontdesk@granlibakken.com' }
