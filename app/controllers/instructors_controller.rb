  ...
  def create
    ...
    respond_to do |format|
      if @instructor.save
        ...
        format.html { redirect_to '/thanks-for-applying', notice: 'Your instructor application was successfully submitted, you will be contacted shortly. You may also reach out with questions to frontdesk@granlibakken.com' }
